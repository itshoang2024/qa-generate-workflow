...
- `AgentClient` abstract base is implemented with `MockAgentClient` as the default. Agent A, Agent B, and Agent C now have Task 2 structured JSON contracts and OpenAI Responses API adapters behind `AI_PROVIDER=openai`/`real`.
